...
(μ : {p :ℒ × ℒ // p.1 < p.2} → S) :
ConvexI I₁ μ → ConvexI I₂ μ := fun hμcvx₁ x y hxI hyI hxy ↦ hμcvx₁ x y ⟨le_trans hI.1 hxI.1, le_trans hxI.2 hI.2⟩ ⟨le_trans hI.1 hyI.1, le_trans hyI.2 hI.2⟩ hxy
...
ConvexI I μ ↔ Convex (Resμ I μ) := ⟨fun h1 h2 h3 h4 h5 => h1 h2 h3 h4 h5,fun h1 h2 h3 h4 h5 h6 ↦ h1 ⟨h2,h4⟩ ⟨h3,h5⟩ (in_TotIntvl _) (in_TotIntvl _) h6⟩
end
